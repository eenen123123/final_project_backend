...
└── 개인 페이지 관리          /instructor/profile/instructor
```
...
**클래스룸 페이지로 위임하는 기능** _(관리자 페이지에서 구현 금지)_
...
- 프로필 관리(`/instructor/profile/instructor`)와 분리: 공개 페이지에서 함께 노출되더라도 관리 도구는 기능별로 독립
...
### 3.9 개인 페이지 관리 `/instructor/profile/instructor`
...
<div class="sidebar-section">
    <p class="sidebar-title text-sky-500">강사 전용 권한</p>
    <ul class="sidebar-list">
        ...
        <li>
            <a href="/instructor/ai-questions" class="sidebar-link group">
                <i
                    class="fa-solid fa-wand-magic-sparkles sidebar-icon group-hover:text-sky-400"
                ></i>
        ...
        <li>
            <a href="/instructor/profile/instructor" class="sidebar-link">
