...
public class CouponController {
    ...
    public ResponseEntity<List<MemberCouponPointDto>> getExpiringCoupons(Authentication authentication) {
    ...
    public ResponseEntity<MemberCouponPointDto> redeemCoupon(Authentication authentication,
        ...
        MemberCouponPointDto issued = couponService.redeemCoupon(body.get("couponCode"), authentication.getName());
