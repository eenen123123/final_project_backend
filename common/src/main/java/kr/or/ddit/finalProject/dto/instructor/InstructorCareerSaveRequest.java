 ...
 * 약력 항목 단건 저장 요청 DTO
 *
 * POST /instructor/profile/instructor/careers 폼 제출 시 바인딩됩니다. 저장 전 instrUserId는
 * 컨트롤러에서 로그인 사용자 ID로 주입합니다.
 *
 * [유형별 연도 입력 규칙] - 약력(01) : careerStrtYr + careerEndYr (기간, endYr 비워두면 "현재") -
...
public class InstructorCareerSaveRequest {
    ...
    /**
     * 종료 연도 (4자리, nullable) 비어있으면 null로 처리 → 화면에서 "현재"로 표시
     */
