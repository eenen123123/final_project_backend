...
import kr.or.ddit.finalProject.dto.chat.MsgContDto;
import kr.or.ddit.finalProject.dto.chat.MsgRoomDto;
...
public interface ChatService {
     ...
     */
    MsgRoomDto getOrCreateOneOnOneChatRoom(String myId, String otherId);
     ...
     * @return              해당 채팅방 정보
     */
    MsgRoomDto getGroupChatRoom(long roomSn);
     ...
     */
    List<MsgContDto> getChatMessages(long roomSn, int page, int screenSize);
     ...
     * @return              생성된 그룹 채팅방   
     */
    MsgRoomDto createGroupChatRoom(String roomNm, String opnrUserId, List<String> partUserIds);
     ...
     */
    List<MsgRoomDto> getChatRoomList(String userId);
